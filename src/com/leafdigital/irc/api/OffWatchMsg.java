...
public class OffWatchMsg extends WatchMsg
{
	/**
	 * @param s Server
	...
	public static MessageInfo info=new MessageInfo(OffWatchMsg.class,"User offline",
		"<para>A user is marked as offline.</para>" +
		"<small>This event applies only to watched users. It occurs either when a " +
		"user just disconnected, or when they were just removed from the watch list. " +
