...
public class UserNoticeIRCMsg extends UserIRCMsg
{
	 ...
	 */
	public UserNoticeIRCMsg(IRCUserAddress source,String targetNick,byte[] text)
	{
	...
	public String toString()
	{
		return super.toString()+
		  "  [UserNoticeIRCMessage]\n"+
			"  Text: "+IRCMsg.convertISO(getText())+"\n";
	}

	/** Scripting event information. */
	public static MessageInfo info=new MessageInfo(UserNoticeIRCMsg.class,"Notice",
		"A private notice.")
	{
		@Override
